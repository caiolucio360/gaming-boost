          ...
          {features.map((feature, i) => (
            ...
            >
              ...
              <CardContent className="flex flex-col items-center p-0 relative z-10">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-brand-purple/20 to-brand-purple-dark/20 group-hover:from-brand-purple/30 group-hover:to-brand-purple-dark/30 transition-all duration-300 mb-4">
                  <feature.icon
