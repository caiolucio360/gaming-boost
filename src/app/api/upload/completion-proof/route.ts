...
import { verifyBooster, createAuthErrorResponseFromResult } from '@/lib/auth-middleware'
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!file) {
      return NextResponse.json({ message: 'Nenhum arquivo enviado.' }, { status: HttpStatus.BAD_REQUEST })
    }
