            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full p-3 rounded-lg bg-black/50 border border-purple-500/50 text-white placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400 focus:outline-none resize-none"
                />
              </div>
