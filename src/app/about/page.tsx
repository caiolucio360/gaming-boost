      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12 sm:py-16 lg:py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground font-rajdhani group-hover:text-foreground transition-colors duration-300" style={{ fontWeight: '500' }}>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <Card className="group relative bg-card border-brand-purple/50 hover:border-brand-purple-light/80 hover:shadow-xl hover:shadow-brand-purple/20 transition-colors duration-200 overflow-hidden">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className="text-3xl font-bold text-foreground font-orbitron group-hover:text-brand-purple-light transition-colors duration-300" style={{ fontWeight: '700' }}>
                  <span className="bg-gradient-to-r from-brand-purple-light to-brand-purple-light bg-clip-text text-transparent">NOSSA</span>
                  <span className="text-foreground"> HISTÓRIA</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6 relative z-10">
                <p className="text-muted-foreground font-rajdhani leading-relaxed group-hover:text-foreground transition-colors duration-300" style={{ fontWeight: '400' }}>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="pt-6 text-center relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-foreground font-orbitron mb-3 group-hover:text-brand-purple-light transition-colors duration-300" style={{ fontWeight: '700' }}>
                    {feature.title}
                  </h3>
                  <p className="text-muted-foreground font-rajdhani group-hover:text-foreground transition-colors duration-300" style={{ fontWeight: '400' }}>
                    {feature.description}
                  </p>
                </CardContent>
              </Card>
